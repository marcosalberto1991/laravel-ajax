                        ...
                        <tbody>
                            @foreach($listmysql as $indexKey => $lists)
                                <tr class="item{{$lists->id}} @if($lists->is_published) warning @endif">
                                    ...
                                    <td>{{$lists->nombre}}</td>
                                    <td>
                                        {{App\Post::getExcerpt($lists->mensajec)}}
                                    </td>
                                    <td>{{$lists->punto}}</td>

                                    <td>{{$lists->respuestas}}</td>
                                    <td>{{$lists->idcomentario}}</td>
                                    <!--
                                    <td class="text-center"><input type="checkbox" class="published" id="" data-id="{{$lists->id}}" @if ($lists->is_published) checked @endif></td>
                                    ...
                                    <td>
                                        ...
                                        data-mensajec="{{$lists->mensajec}}"
                                        data-punto="{{$lists->punto}}"
                                        data-respuestas="{{$lists->respuestas}}"
                                        data-idcomentario="{{$lists->idcomentario}}"
                                        >
