...
-->
 <section class="col-lg-11 connectedSortable">
   ...
   <br>
    <table class="table table-bordered">
      ...
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td><?php echo e($x -> password); ?></td>
          <td><?php echo e($x -> email); ?></td>
          <td>
              <a href="Author/edit/<?php echo e($x -> id); ?>" class="btn btn-warning"   onclick="fun_edit('<?php echo e($x -> id); ?>')">Edit</a>
          </td>
          <td>
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="<?php echo e(url('Author/view')); ?>">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="<?php echo e(url('Author/delete')); ?>">
    <!-- Add Modal start -->
